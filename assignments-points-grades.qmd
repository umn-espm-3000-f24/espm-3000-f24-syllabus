...
During the final class session, you will share with your small group one of two choices of synthesis assignment that you have completed. You can either:
- 1) Create a figure that synthesizes or provides information on a permafrost-related topic we have discussed or
- 2) You can critique an article (choices will be provided) addressing a permafrost-related topic from a popular news source. This assignment will be due on the last day of class (December 6th).
